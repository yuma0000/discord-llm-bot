...
def format_message_info(message):
    text = []
    text.append("===== MESSAGE INFO =====")
    text.append(f"id: {message.id}")
    text.append(f"content: {message.content}")
    text.append("")
    text.append("----- author -----")
    text.append(f"author: {message.author}")
    text.append(f"author_id: {message.author.id if message.author else None}")
    text.append("")
    text.append("----- channel -----")
    text.append(f"channel: {message.channel}")
    text.append(f"channel_id: {message.channel.id if message.channel else None}")
    text.append("")
    text.append("----- guild -----")
    text.append(f"guild: {message.guild}")
    text.append(f"guild_id: {message.guild.id if message.guild else None}")
    text.append("")
    text.append("----- member -----")
    text.append(f"member: {message.member}")
    text.append("")
    text.append("----- mentions -----")
    text.append(f"mentions: {[str(u) for u in message.mentions]}")
    text.append("")
    text.append("----- attachments -----")
    text.append(f"attachments: {[a.url for a in message.attachments]}")
    text.append("")
    text.append("----- embeds -----")
    text.append(f"embeds: {len(message.embeds)}")
    text.append("")
    text.append("----- reactions -----")
    text.append(f"reactions: {[str(r.emoji) for r in message.reactions]}")
    text.append("")
    text.append("----- components -----")
    text.append(f"components: {message.components}")
    text.append("")
    text.append("----- flags -----")
    text.append(f"flags: {message.flags}")
    text.append("")
    text.append("----- reference -----")
    text.append(f"reference: {message.reference}")
    text.append("")
    text.append("----- thread -----")
    text.append(f"thread: {message.thread}")
    text.append("")
    text.append("----- interaction -----")
    text.append(f"interaction: {message.interaction}")
    text.append("")
    text.append("----- stickers -----")
    text.append(f"stickers: {message.stickers}")
    text.append("")
    text.append("----- application -----")
    text.append(f"application_id: {message.application_id}")
    text.append("")
    text.append("----- webhook -----")
    text.append(f"webhook_id: {message.webhook_id}")
    text.append("")
    text.append("----- system -----")
    text.append(f"system: {message.system}")
    text.append("")
    text.append("----- position -----")
    text.append(f"position: {message.position}")
    return "\n".join(text)
